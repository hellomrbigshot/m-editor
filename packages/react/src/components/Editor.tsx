...
export default function Editor(props: EditorProps) {
	...
	const getColumnLines = useMemoizedFn(() => {
		// get column length
	...
	useEffect(() => {
		// do once when componentdidmounted
	...
	return (
		<div ref={mEditor} className={classnames('editor', `${theme}-editor`, fullScreen && 'editor-fullscreen')}>
			<ToolBar
			...
			<div className="editor-content">
				<div
					className={classnames('editor-content-edit', mode === 'edit' && 'active', mode === 'preview' && 'inactive')}
					ref={editWrapper}
					onMouseEnter={() => {
						setScrollType('edit')
					}}
				...
				>
					<div className="editor-content-edit-block">
						{showLineNum ? <Column length={columnsLength} /> : null}
